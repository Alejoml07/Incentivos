...
namespace PuntosLeonisa.Seguridad.Function
{
    public class Authentication
    {
        ...
        public async Task<IActionResult> ValidarCorreo(
           [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "Seguridad/ValidarCorreo/{email}")] HttpRequest req,
           ILogger log, string email)
        {
            try
            {
                ...
                var response = await usuarioApplication.ValidarCorreo(email);              
